<#
	...
	.DESCRIPTION
		...
		4.5 - (June 18, 2025) Fixed https://github.com/AndrewRathbun/KAPE-EZToolsAncillaryUpdater/issues/26
...
function Get-ZimmermanTools
{
	...
	{
		Log -logFilePath $logFilePath -msg "Start-BitsTransfer failed to download $ZTZipFile from $ZTdlUrl. Error: $($_.Exception.Message). Attempting Invoke-WebRequest."
		try
		{
			Invoke-WebRequest -Uri $ZTdlUrl -OutFile (Join-Path $kapeModulesBin $ZTZipFile) -ErrorAction Stop
		}
		catch
		{
			Log -logFilePath $logFilePath -msg "Invoke-WebRequest also failed to download $ZTZipFile from $ZTdlUrl. Error: $($_.Exception.Message)"
		}
	}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDTeL1p7/1//zyv
# vA7i+5F5pMGoCFskH6Qr85NXM5zziKCCKJAwggQyMIIDGqADAgECAgEBMA0GCSqG
...
# CisGAQQBgjcCAQQwLwYJKoZIhvcNAQkEMSIEIChCfeq5K8GrHOAn6Uf1Z2yEW6Hg
# nfzi09G+PpR+oKi9MA0GCSqGSIb3DQEBAQUABIICAG2IdH3l4xj8SQVBhQz5aOv/
# sqpqZwQSqS3QeghKPq9xNBMHcRhQ7ir3we1SvmVlfxOCFHj0cF63X5W67se5yPtY
# m6BYAZ8uIhZsXgj3DyHq+AJLn/E1KbdhVjTSCzxUA4CvbAv10aVQ7h0ppQ88ED9i
# AwBwsX83nrPVW3i4Bm1BEF0Ve0lEcFuxUHWlbdFHz2eaCWW/yZsankQrKy3xjaLh
# WCJN/6pUKNggeU/PEyWsRCJD6wLQqZdxhxQkoOL1wYHuz4E1LJbwlV5vPG/tdJDJ
# wyLUbPs4dW/e0Df2oXEfetaO2MY9NY2GEshItNJJMB2frIUj9YHeQsIx2y7ATI1h
# dxY/pvzJoUAFckiBwvy1TRheYXtE5TeD9flgMypqOTeSO0Xcet6QtKA/fpuUbphV
# 7ZF+yHXxohi7Li17h8dy0KudIlHHdjyM3YKphr/kRwT2k6I+pOOR0ehjDMJrnDvr
# 7Duzx0J0OTMZWkdjaf/4zjFpdA9D9FTVVZ/RotJsblcr4wReigSHqjDQW+tdpagI
# Jhy7uOGu2W480bF3rmXurcppwz4GrUAOxDSERULVujSssgEBzqEOfmaHEpB7eLXU
# YJMsD8o/iiKoCkT5xfEj/MHYRs99oVcb8nKvepOS60gFwe5Vl4hChjQxv+Ts5Z3M
# wt9eXtB0f/EeWabMaJaQoYIDbDCCA2gGCSqGSIb3DQEJBjGCA1kwggNVAgEBMG8w
...
# KoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yNTA2MjQxMzEwMDlaMCsGCSqGSIb3
# DQEJNDEeMBwwCwYJYIZIAWUDBAIBoQ0GCSqGSIb3DQEBCwUAMC8GCSqGSIb3DQEJ
# BDEiBCCf641dzbR9/LQl+qEXj5kkWO+odZywLWoLNPFVXljjnDCBpAYLKoZIhvcN
...
# 85u0U3OWiccagp0yMA0GCSqGSIb3DQEBCwUABIIBgDc7Na2ZpbrLnAok0gP0bMUA
# 8EC2WLIT/myNlEcCoUWMNtVgQ5K78Z/jFbNhnejqMmOhNwI5d+gxXupqiZfmz/Jd
# UGuboXSdvagHguztUJtjDpHFWkDLa/Fbp6wZQaYzDCf4aOAX7J4CatZ+0Iu9pn23
# z3pRzVE5NwTQ7sPF7tgomvSJLwWHZqCkVm2L4a7h021F7z+57FNCIFq0Io3oe97/
# P5gXi4rphymb9QuvATe8mFDND3MMPLidOG9+aOB5I5mpru0Qm9GswJrmANAx4J8c
# xSGGL9dqVhcctL8MqtgelrDDSH95sNMtd5DXjLARuV5SA86t0h1nMdeNqva8c6zL
# b0TqgGoVNxhsSBDS8F15Mmb49c01WSNQb6yi2h46PP+/l/jKLCHQcj5OWTHAlEUC
# bXw4Uw0TYR9PbZ8gdszZz7B0jDTPrycoy82snt5P/Du3Su/zdPjifKbsnJ9/FaEn
# RrjtbM7lsJni75fkDQYqFlCTE2ryHe0Kia7W+i6Xqw==
